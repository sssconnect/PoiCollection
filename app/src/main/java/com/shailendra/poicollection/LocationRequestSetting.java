...
public class LocationRequestSetting {

    private String TAG = "LocationRequestSetting";
    /**
    ...
    LocationRequestSetting(Activity activity, Long UPDATE_INTERVAL_IN_MILLISECONDS,
